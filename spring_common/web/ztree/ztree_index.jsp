  ...
  <head>
	...
	<script type="text/javascript">
		...
		function zTreeOnClick(event, treeId, treeNode) {
			window.open(treeNode.localUrl,"testIframe");
		};
		...
		function openUrl(url){
			alert('openUrl');
// 			window.open(url,"testIframe");
		}
		function openOnUrl(url){
			alert('openOnUrl');
// 			window.open(url,"testIframe");
		}
	...
	<TABLE border=0 height="100%" width="100%" align=left>
		<TR>
			<TD width=20% align=left valign=top>
				<IFRAME ID="treeIframe" Name="treeIframe" FRAMEBORDER=0  width=100%  height=100% src="<%=path%>/ztree/asyncZtree.jsp">
				</IFRAME>
			</TD>
